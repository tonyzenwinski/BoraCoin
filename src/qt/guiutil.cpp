...
{
    // Convert Bora:// to Bora:
    //
    //    Cannot handle this later, because bitcoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("Bora://", Qt::CaseInsensitive))
    {
        uri.replace(0, 11, "Bora:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Bora.lnk";
}
...
{
    return GetAutostartDir() / "Bora.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        if (!optionFile.good())
            return false;
        // Write a Bora.desktop file to the autostart directory:
        optionFile << "[Desktop Entry]\n";
        optionFile << "Type=Application\n";
        optionFile << "Name=Bora\n";
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the Bora app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if(fAutoStart && !foundItem) {
        // add Bora app to startup item list
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Bora-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  Bora-qt [" + tr("command-line options") + "]                     " + "\n";
...
{
    app.setStyleSheet("QWidget        { background: rgb(96,103,112); }"
                      "QFrame         { border: none; }"
                      ...
                      "QMenuBar       { background: rgb(96,103,112); color: rgb(110,116,126); }"
                      "QMenu          { background: rgb(55, 58, 63); color: rgb(222,222,222); }"
                      ...
                      "QTabBar::tab:selected  { background: rgb(96,103,112); }"
                      ...
                      "QTreeView::item { background: rgb(96,103,112); color: rgb(212,213,213); }"
                      ...
                      "QToolBar       { background: rgb(55, 58, 63); border: none; }");
}
