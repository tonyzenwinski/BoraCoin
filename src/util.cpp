...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Bora
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Bora
    // Mac: ~/Library/Application Support/Bora
    // Unix: ~/.Bora
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bora";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Bora.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "borad.pid"));
