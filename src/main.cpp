...
const string strMessageMagic = "Bora Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    } else if (nHeight >= 2 && nHeight <= 7){
      nSubsidy = 0 * COIN;
    } else if (nHeight == 8){
      nSubsidy = 1500000 * COIN;
    } else if (nHeight >= 9 && nHeight <= 14){
      nSubsidy = 0 * COIN;
    } else if (nHeight == 15){
      nSubsidy = 1500000 * COIN;
    } else if (nHeight >= 16 && nHeight <= 21){
      nSubsidy = 0 * COIN;
    } else if (nHeight == 22){
      nSubsidy = 900000 * COIN;
    } else if (nHeight >= 23 && nHeight <= 28){
      nSubsidy = 0 * COIN;
    } else if(nHeight == 29){
      nSubsidy = 600000 * COIN;
    } else if(nHeight >= 30 && nHeight <= 35){
      nSubsidy = 0 * COIN;
    } else if(nHeight == 36){
      nSubsidy = 1500000 * COIN;
    } else if(nHeight >= 37 && nHeight <= 42){
      nSubsidy = 0 * COIN;
    } else if(nHeight == 43){
      nSubsidy = 3000000 * COIN;
    } else if(nHeight >= 44 && nHeight <= 49){
      nSubsidy = 0 * COIN;
    } else if(nHeight == 50){
      nSubsidy = 4950000 * COIN;
    } else if(nHeight >= 51 && nHeight <= 56){
      nSubsidy = 0 * COIN;
    } else if(nHeight == 57){
      nSubsidy = 5100000 * COIN;
    } else if(nHeight >= 58 && nHeight <= 63){
      nSubsidy = 0 * COIN;
    } else if(nHeight == 64){
      nSubsidy = 4500000 * COIN;
    } else if(nHeight >= 65 && nHeight <= 70){
      nSubsidy = 0 * COIN;
    } else if(nHeight == 71){
      nSubsidy = 4950000 * COIN;
    } else if(nHeight >= 72 && nHeight <= 120){
      nSubsidy = 0 * COIN;
    } else if(nHeight >= 121 && nHeight <= 4320){
      nSubsidy = 3 * COIN;
    } else if(nHeight >= 4321 && nHeight <= 38880){
      nSubsidy = 1 * COIN;
    } else {
      nSubsidy = 0 * COIN;
    }
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if(nBestHeight >= 1 && nBestHeight <= 4320){
      nSubsidy = 0 * COIN;
...
static int64_t nTargetTimespan = 24 * 60;  // 48 mins
